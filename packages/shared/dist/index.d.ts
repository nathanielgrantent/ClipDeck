...
export type ModActionType = 'REMOVE' | 'APPROVE' | 'FILTER' | 'BAN' | 'UNBAN' | 'REPORT' | 'NOTIFY' | 'WARN' | 'APPEAL';
export type AutomodActionType = 'REMOVE' | 'FILTER' | 'REPORT' | 'NOTIFY';
export declare const MAX_UPLOAD_BYTES: number;
export declare const MAX_TAGS_PER_POST = 5;
export declare const MAX_POST_TITLE_LENGTH = 300;
export declare const MAX_COMMENT_LENGTH = 10000;
...
export declare function parseStringArray(value: string | null | undefined): string[];
export declare function serializeStringArray(value: string[]): string;
